...
/****************************************************
 *Input Parameter Options of Function : GPIO_SetPinAF ( GPIO_strPin_t* Pin);
...
/****************************************************
 *Input Parameter Options of Function : GPIO_initPin  (uint32 Pin , void* Port , uint32 AF);
 *The Input Parameter :	AF
 *Representation      : Representing the Alternative Function Type.
 *
*****************************************************/
#define AF0_SYSTEM			0
#define AF1_TIM1_TIM2		1
#define AF2_TIM3_TIM5		2
#define AF3_TIM9_TIM11		3
#define AF4_I2C1_I2C3		4
#define AF5_SPI1_SPI4		5
#define AF6_SPI3			6
...
/*************************/
/* GPIO_SetPinAF Function*/
/*************************/
/*
 * @input parameters: uint32 Pin (Pin number), uint32 Port (Port number),uint32 AF (The Alternative Function)
 * @output parameters: GPIO_EnumErrorState (Error state indicating success or failure)
 * @description: Sets The Alternative function Of The Pin.
 */



GPIO_EnumErrorState GPIO_SetPinAF (uint32 Pin , void* Port , uint32 AF);
